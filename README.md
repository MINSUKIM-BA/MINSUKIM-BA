...
The placeholder portfolio image can be replaced by the desired image by placing it as `assets/profile.png` in your jekyll website, or by changing the following line in `_config.yaml`
